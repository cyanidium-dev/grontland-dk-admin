  ...
  fields: [
          ...
          of: [
            {
              ...
              fields: [
                ...
                defineField({name: 'caption', title: 'Caption', type: 'localeText', validation: (r) => r.required()}),
              ],
              preview: {select: {title: 'caption.da', media: 'image'}},
            },
          ],
          validation: (r) => r.max(2),
        }),
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({name: 'teamH3', title: 'Team sub-heading', type: 'localeString'}),
        defineField({name: 'teamText', title: 'Team text', type: 'localeText'}),
        defineField({
          name: 'trades',
          title: 'Trade tags',
          type: 'array',
